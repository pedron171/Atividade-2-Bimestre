...
<nav class="navbar navbar-dark topbar mb-4">
  <div class="container">
    <a class="navbar-brand" href="<?php echo e(route('tarefas.index')); ?>">Tarefas</a>
    <div class="d-flex gap-2">
      <a class="btn btn-light btn-sm" href="<?php echo e(route('tarefas.index')); ?>">Lista</a>
      <a class="btn btn-light btn-sm" href="<?php echo e(route('categorias.index')); ?>">Categorias</a>
    </div>
  </div>
</nav>
...
<?php /**PATH C:\Users\UniALFA\Documents\tarefas\resources\views/layouts/app.blade.php ENDPATH**/ ?>